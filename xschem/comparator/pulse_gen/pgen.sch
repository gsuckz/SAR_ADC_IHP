...
N 230 -30 250 -30 {lab=vy}
N 250 -60 250 -30 {lab=vy}
N 415 -60 590 -60 {lab=vy}
N -39 468 -39 488 {lab=#net1}
N -39 368 -39 388 {lab=vsti}
N -39 268 -39 288 {lab=#net2}
...
N 151 368 221 368 {lab=vsti}
N -39 348 -39 368 {lab=vsti}
N 151 358 151 368 {lab=vsti}
N -39 368 151 368 {lab=vsti}
N 151 368 151 388 {lab=vsti}
N -39 268 121 268 {lab=#net2}
N -39 258 -39 268 {lab=#net2}
N 121 268 121 318 {lab=#net2}
N -39 468 121 468 {lab=#net1}
N -39 448 -39 468 {lab=#net1}
N 121 428 121 468 {lab=#net1}
...
N 190 -60 200 -60 {lab=#net3}
N 415 -100 415 -60 {lab=vy}
N 250 -60 415 -60 {lab=vy}
...
C {lab_pin.sym} 415 -97 0 0 {name=p3 sig_type=std_logic lab=vy}
C {lab_pin.sym} 61 368 0 1 {name=p8 sig_type=std_logic lab=vsti}
