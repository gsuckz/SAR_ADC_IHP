...
N 700 -620 700 -600 {lab=vcap}
N 700 -520 700 -480 {lab=VSS}
N 700 -640 700 -620 {lab=vcap}
N 580 -620 580 -600 {lab=vcap}
...
m=1
spiceprefix=X}
C {lab_wire.sym} 700 -620 0 1 {name=p24 sig_type=std_logic lab=vcap}
