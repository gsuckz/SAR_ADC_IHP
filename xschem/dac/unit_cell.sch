...
C {devices/iopin.sym} 1440 -1000 3 0 {name=p2 lab=A}
C {devices/iopin.sym} 1500 -880 1 0 {name=p20 lab=VDD}
C {devices/ipin.sym} 1400 -940 0 0 {name=p14 lab=D}
C {devices/iopin.sym} 1480 -1000 3 0 {name=p3 lab=B}
C {devices/iopin.sym} 1460 -790 1 0 {name=p6 lab=vtop}
C {dac_icms_cell/dac_switch.sym} 1460 -940 2 0 {name=x1 W_P_TG=3.0u L_P_TG=0.13u W_N_TG=1.0u L_N_TG=0.13u}
C {sg13g2_pr/cap_cmim.sym} 1460 -820 0 0 {name=C1
model=cap_cmim
w=7.0e-6
l=7.0e-6
m=1
