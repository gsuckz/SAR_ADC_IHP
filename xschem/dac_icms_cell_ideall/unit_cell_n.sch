...
N 1135 -1495 1135 -1435 {lab=VDD}
N 1215 -1395 1330 -1395 {lab=bitn}
N 1215 -1215 1330 -1215 {lab=dn}
N 1135 -1315 1135 -1255 {lab=VDD}
N 1290 -890 1290 -800 {lab=#net4}
N 1210 -890 1290 -890 {lab=#net4}
C {devices/title-3.sym} 0 0 0 0 {name=l1 author="Simon Dorrer" rev=1.0 lock=true}
C {devices/iopin.sym} 1935 -1110 3 0 {name=p5 lab=VSS}
C {devices/iopin.sym} 790 -970 3 0 {name=p2 lab=v_in}
C {devices/ipin.sym} 1075 -1215 0 0 {name=p14 lab=d}
C {devices/ipin.sym} 1075 -1395 3 1 {name=p3 lab=bit
}
...
C {inverter/inverter_lv.sym} 1135 -1395 0 0 {name=x8 W_P=W_P_SPDT L_P=L_P_SPDT W_N=W_N_SPDT L_N=L_N_SPDT n=n}
C {devices/lab_pin.sym} 1135 -1355 0 0 {name=p22 lab=VSS}
C {devices/lab_pin.sym} 1135 -1495 0 0 {name=p23 lab=VDD}
C {devices/lab_pin.sym} 1325 -1395 0 1 {name=p24 lab=bitn}
C {devices/lab_pin.sym} 1975 -1080 0 1 {name=p9 lab=bitn}
C {inverter/inverter_lv.sym} 1135 -1215 0 0 {name=x1 W_P=W_P_SPDT L_P=L_P_SPDT W_N=W_N_SPDT L_N=L_N_SPDT  n=n}
C {devices/lab_pin.sym} 1135 -1175 0 0 {name=p26 lab=VSS}
C {devices/lab_pin.sym} 1135 -1315 0 0 {name=p27 lab=VDD}
C {devices/lab_pin.sym} 1325 -1215 0 1 {name=p28 lab=dn}
C {devices/lab_pin.sym} 2040 -1000 0 1 {name=p25 lab=dn}
C {bootstrap/bootstrap.sym} 1060 -890 0 0 {name=x2}
C {capa.sym} 1290 -775 0 0 {name=C1
m=n
value=Cu
footprint=1206
device="ceramic capacitor"}
C {bootstrap/bootstrap.sym} 1060 -650 0 0 {name=x3}
C {bootstrap/bootstrap.sym} 1050 -380 0 0 {name=x4}
