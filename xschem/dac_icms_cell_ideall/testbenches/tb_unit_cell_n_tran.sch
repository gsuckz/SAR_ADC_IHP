...
C {vsource.sym} -340 -60 0 0 {name=V2 value="PULSE(0 1.8 0 10p 10p 5n 10n" savecurrent=false}
...
C {vsource.sym} -600 -270 0 0 {name=V4 value="PULSE(1.8 0 0 10p 10p 20n 50n 2)" savecurrent=false}
...
C {vsource.sym} -610 -130 0 0 {name=V5 value="PULSE(-10 10 0 10p 10p 15n 50n 1)" savecurrent=false}
...
C {vsource.sym} -610 -10 0 0 {name=V7 value="PULSE(-10 10 0 10p 10p 15.2n 50n 1)" savecurrent=false}
