...
C {vsource.sym} 950 790 0 0 {name=V1 value="PULSE( 1.8 0 \{delay_n\} \{rise_t\} \{fall_t\} \{a*period/2\} \{a*period\} )" savecurrent=false}
C {gnd.sym} 950 820 0 0 {name=l1 lab=GND}
C {vsource.sym} 950 695 0 0 {name=V5 value="PULSE( 0 1.8 \{delay_n\} \{rise_t\} \{fall_t\} \{a*period/2\} \{a*period\} )" savecurrent=false}
C {gnd.sym} 950 725 0 0 {name=l2 lab=GND}
C {lab_pin.sym} 950 760 0 1 {name=p25 sig_type=std_logic lab=clk}
C {lab_pin.sym} 950 665 0 1 {name=p26 sig_type=std_logic lab=clk_n}
