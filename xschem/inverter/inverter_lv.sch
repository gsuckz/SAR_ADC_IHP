...
N 1180 -870 1180 -840 {
lab=vout}
C {devices/ipin.sym} 1080 -840 0 0 {name=p10 lab=vin}
C {devices/iopin.sym} 1240 -980 3 0 {name=p11 lab=VDD}
C {devices/iopin.sym} 1240 -700 1 0 {name=p1 lab=VSS}
C {devices/opin.sym} 1280 -840 0 0 {name=p2 lab=vout}
C {title-3.sym} 0 0 0 0 {name=l1 author="Simon Dorrer" rev=1.0 lock=true}
C {sg13g2_pr/sg13_lv_pmos.sym} 1160 -900 0 0 {name=M1
l=L_P
w=W_P
ng=1
m=n
...
C {sg13g2_pr/sg13_lv_nmos.sym} 1160 -780 0 0 {name=M2
l=L_N
w=W_N
ng=1
m=n
