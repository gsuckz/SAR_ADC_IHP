...
C {transmission_gate/transmission_gate_lv_w_dummy.sym} 1450 -620 0 0 {name=x2 W_P=W_P_TG L_P=L_P_TG  W_N=W_N_TG L_N=L_N_TG n=n}
C {devices/lab_pin.sym} 1470 -420 3 0 {name=p14 sig_type=std_logic lab=di_spdt_ctrl}
C {devices/lab_pin.sym} 1430 -500 3 0 {name=p15 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 1430 -740 1 0 {name=p16 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 1470 -820 1 0 {name=p18 sig_type=std_logic lab=di_spdt_ctrl_n}
C {sg13g2_stdcells/sg13g2_dlygate4sd2_1.sym} 1470 -780 1 0 {name=x40 VDD=VDD VSS=VSS prefix=sg13g2_ }
C {sg13g2_stdcells/sg13g2_dlygate4sd2_1.sym} 1470 -460 3 0 {name=x4 VDD=VDD VSS=VSS prefix=sg13g2_ }
