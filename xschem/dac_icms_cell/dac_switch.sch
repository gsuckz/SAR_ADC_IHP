...
C {devices/lab_pin.sym} 1470 -500 3 0 {name=p14 sig_type=std_logic lab=di_spdt_ctrl}
...
C {devices/lab_pin.sym} 1470 -740 1 0 {name=p18 sig_type=std_logic lab=di_spdt_ctrl_n}
