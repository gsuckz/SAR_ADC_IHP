...
N 1460 -880 1460 -850 {lab=vcap}
N 1440 -1135 1440 -1000 {lab=B}
N 1265 -1135 1440 -1135 {lab=B}
N 1260 -940 1400 -940 {lab=D}
N 1260 -940 1260 -930 {lab=D}
N 1255 -930 1260 -930 {lab=D}
...
C {dac_icms_cell/dac_switch.sym} 1460 -940 2 0 {name=x1 W_P_TG=3.0u L_P_TG=0.13u W_N_TG=1.0u L_N_TG=0.13u n=n}
...
C {lab_pin.sym} 1460 -870 0 0 {name=p7 sig_type=std_logic lab=vcap}
