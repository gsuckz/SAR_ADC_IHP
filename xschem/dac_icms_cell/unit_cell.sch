...
C {dac_icms_cell/dac_switch.sym} 1460 -940 2 0 {name=x1 W_P=W_P L_P=L_P_SPDT  W_N=W_N L_N=L_N_SPDT n=n}
...
C {transmission_gate/transmission_gate_lv_wo_dummy.sym} 1630 -745 0 1 {name=x2 W_P=W_P_SPDT L_P=L_P_SPDT  W_N=W_N_SPDT L_N=L_N_SPDT n=n}
