...
T {Asample alrteves} 1235 -720 0 0 0.2 0.2 {}
...
C {dac_icms_cell/dac_switch.sym} 1460 -940 2 0 {name=x1 W_P=W_P_SPDT L_P=L_P_SPDT  W_N=W_N_SPDT L_N=L_N_SPDT n=n}
C {devices/iopin.sym} 1480 -1000 3 0 {name=p1 lab=v_cm}
C {devices/ipin.sym} 1630 -785 3 1 {name=p4 lab=a_sample_n}
C {devices/ipin.sym} 1630 -705 1 1 {name=p7 lab=a_sample}
C {transmission_gate/transmission_gate_lv_wo_dummy.sym} 1630 -745 0 0 {name=x2 W_P=W_P_SPDT L_P=L_P_SPDT  W_N=W_N_SPDT L_N=L_N_SPDT n=n}
C {devices/lab_pin.sym} 1610 -785 0 0 {name=p8 lab=VDD}
C {devices/lab_pin.sym} 1610 -705 0 0 {name=p9 lab=VSS}
