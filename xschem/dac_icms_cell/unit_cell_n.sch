...
N 1440 -1265 1440 -1020 {lab=#net2}
N 1410 -1265 1440 -1265 {lab=#net2}
N 1325 -940 1400 -940 {lab=#net3}
N 1325 -940 1325 -935 {lab=#net3}
...
C {devices/ipin.sym} 1205 -935 0 0 {name=p14 lab=D}
C {devices/iopin.sym} 1290 -1265 2 0 {name=p3 lab=B}
C {devices/iopin.sym} 1460 -790 1 0 {name=p6 lab=vtop}
C {dac_icms_cell/dac_switch_n.sym} 1460 -940 2 0 {name=x1 W_P_TG=3.0u L_P_TG=0.13u W_N_TG=1.0u L_N_TG=0.13u n=\{1\}}
C {capa.sym} 1460 -820 0 0 {name=C1
m=n
value=cu
footprint=1206
device="ceramic capacitor"}
C {buffer/buffer_lv.sym} 1350 -1265 0 0 {name=x35 W_P_INV=10.0u L_P_INV=0.13u W_N_INV=10.0u L_N_INV=0.13u}
...
C {buffer/buffer_lv.sym} 1265 -935 0 0 {name=x2 W_P_INV=10.0u L_P_INV=0.13u W_N_INV=10.0u L_N_INV=0.13u}
