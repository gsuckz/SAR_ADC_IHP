...
meas tran bit10 FIND d10 when eoc=1.7 CROSS=LAST
meas tran bit9 FIND d9 when eoc=1.7 CROSS=LAST
meas tran bit8 FIND d8 when eoc=1.7 CROSS=LAST
meas tran bit7 FIND d7 when eoc=1.7 CROSS=LAST
meas tran bit6 FIND d6 when eoc=1.7 CROSS=LAST
meas tran bit5 FIND d5 when eoc=1.7 CROSS=LAST
meas tran bit4 FIND d4 when eoc=1.7 CROSS=LAST
meas tran bit3 FIND d3 when eoc=1.7 CROSS=LAST
meas tran bit2 FIND d2 when eoc=1.7 CROSS=LAST
meas tran bit1 FIND d1 when eoc=1.7 CROSS=LAST
meas tran bit0 FIND d0 when eoc=1.7 CROSS=LAST
print bit11 bit10 bit9 bit8 bit7 bit6 bit5 bit4 bit3 bit2 bit1 bit0
print bit11 bit10 bit9 bit8 bit7 bit6 bit5 bit4 bit3 bit2 bit1 bit0 > "./../../out/sim\{$n\}.txt"
