...
.save time V(d0) V(d1) V(d2) V(d3) V(d4) V(d5) V(d6) V(d7) V(d8) V(d9) V(d10) V(d11) vinp vinn eoc rst compout compp compn x1.comp_clk
.control
run
...
.endc
"}
C {devices/vsource.sym} -520 -370 0 1 {name=VI value="pulse(0 0.9 0 \{stoptime\} 0 \{stoptime+1n\} \{stoptime+2n\})"}
...
C {devices/vsource.sym} -395 -370 2 1 {name=VIN3 value="pulse(0 0.9 0 \{stoptime\} 0 \{stoptime+1n\} \{stoptime+2n\})"}
