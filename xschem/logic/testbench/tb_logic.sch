...
C {vsource.sym} -510 -410 0 0 {name=V2 value="PULSE( 0 1.8 0 10p 10p .5n 1n)" savecurrent=false}
C {lab_pin.sym} -510 -440 0 0 {name=p6 sig_type=std_logic lab=clk
}
C {gnd.sym} -510 -380 0 0 {name=l3 lab=GND}
C {vsource.sym} -500 -310 0 0 {name=V4 value="PULSE(1.8 0 0.5n 10p 10p 3n 8n)" savecurrent=false}
C {lab_pin.sym} -500 -340 0 0 {name=p23 sig_type=std_logic lab=comp_in
}
C {gnd.sym} -500 -280 0 0 {name=l5 lab=GND}
