...
\svgsetup{
	...
	inkscapeversion = 1.4.2,
	inkscapeopt = --export-type=pdf
}
...
Agradezco profundamente a Dios, a la Patria y a la educación pública argentina, pilares fundamentales que hicieron posible mi formación. En particular, expreso mi reconocimiento a la Universidad Nacional de Tucumán, por brindarme el espacio, los recursos y la calidad académica necesarios para desarrollarme profesionalmente.

A mis padres, por su inmenso sacrificio y su apoyo incondicional. A mi mamá, especialmente, por el enorme esfuerzo realizado en los últimos años, que fueron particularmente difíciles, por su rol fundamental en inculcarme disciplina y por confiar profundamente en mis capacidades incluso en los momentos más complejos. A mi papá, por haberme transmitido desde temprano conceptos, ideas y formas de pensar que despertaron en mí el interés y la vocación por esta carrera.

A mis abuelas, mis hermanos y toda familia, por el acompañamiento constante a lo largo de todo este proceso. En especial, a mi tío Hugo, por su apoyo en los momentos más difíciles de la carrera, por su insistencia diaria y por haberme demostrado que siempre es posible seguir adelante.

A todos mis amigos y compañeros de carrera, por el acompañamiento constante, el intercambio de conocimientos y los momentos compartidos a lo largo de este camino.

A mis profesores, tanto de la carrera como de mi formación secundaria en el Instituto Lorenzo Massa, por haber contribuido a mi educación y por motivarme a continuar en el camino de la electrónica.

Finalmente, quiero agradecer a mi tutor, el Dr. Fernando Miranda Bonomi, por su guía, su tiempo y su compromiso no solo durante el desarrollo de esta tesis, sino también a lo largo de varios años en la carrera, siendo una figura clave que marcó profundamente mi forma de trabajar y de abordar los desafíos académicos.
...
Se ilustran algunos diseños propuestos para el layout de un par de bloques. Para el diseño del comparador de Bindra y el Latch SR se intento optimizar la simetría del diseño para disminuir al mínimo el error sistematico, mientras que para el diseño de la celda unitaria del cdac se intento minimizar area. Se incluye el diseño del generador de pulsos para notar como se dibuja el nmos aislado (triple well). Finalmente se dejan algunas imagenes 2.5D renderizadas para ilustrar mejor la vista 3D de los bloques.
\section{Comparador}
\begin{figure}[H]
	\centering
	\includesvg[
...
\begin{figure}[H]
	\centering
	\includegraphics{img/comparadorFullLayoutt}
	\caption{Layout Bindra}
	\label{full_comp}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics{img/pgenlayoutexplicado}
	\caption{Generador de pulso con nmos de triple-well}
	\label{pgen_lo}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics{img/SR_latch_export}
	\caption{Latch SR simétrico}
	\label{SR Latch}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics{img/cdac_unit_cell_lo_explicado}
	\caption{Celda unitaria del CDAC propuesta}
	\label{unit_cdac_lo}
\end{figure}

\section{Imagenes 2.5D}
Dentro del entorno de KLayout se incluye la posibilidad de renderizar imagenes 2.5D para ilustrar mejor el diseño, de dejan un par a modo de ejemplo.



\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{bmp/cdacPrueba}
	\caption{Vista CDAC en perspectiva}
	\label{}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{bmp/cdacPrueba2}
	\caption{Otra vista del CDAC}
	\label{}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{bmp/cdacUnitCellVista}
	\caption{Celdas unitaria del CDAC}
	\label{}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{bmp/cdacUnitCellVistaPattern}
	\caption{Acercamiento a la via de conexion hacia el capacitor de la celda unitaria}
	\label{}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{bmp/ComparadorBaseLayer}
	\caption{Vista de los transistores del comparador Bindra}
	\label{}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{bmp/comparadorVistaTOPConexiones}
	\caption{Conexiones del Preamplificador Bindra}
	\label{}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{bmp/Vista1_comp_lo}
	\caption{Compardor Bindra ocultando los capacitores y capas superiores}
	\label{}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{bmp/Vista1_comp_lo_ConTOPMetal}
	\caption{Comparador Bindra mostrando los capacitorees}
	\label{}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{bmp/Vista1_comp_lo_SeVenLosCaps}
	\caption{Descripción}
	\label{}
\end{figure}
